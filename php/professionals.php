...
$pageTitle = 'SUBZWARI Professional Network';
...
['results' => $members, 'pagination' => $pagination] = search_profiles($filters, $viewerSignedIn, true);

require __DIR__ . '/includes/header.php';
require __DIR__ . '/includes/directory_filters.php';
?>
<div class="container" style="padding:64px 24px;">
  <h1 class="display">SUBZWARI Professional Network</h1>
  <p class="text-muted">Connect with Subzwari professionals for mentorship, referrals, and business introductions.</p>

  <div style="display:flex; flex-wrap:wrap; gap:8px; margin:16px 0;">
    <?php foreach ($categories as $cat): ?>
      <a class="badge badge-neutral" href="?category_id=<?= $cat['id'] ?>"><?= e($cat['name']) ?></a>
    <?php endforeach; ?>
  </div>

  <?php render_directory_filters($countries, true, $categories); ?>

  <?php if (empty($members)): ?>
    <div class="empty-state">No professionals found. Try adjusting your filters.</div>
  <?php else: ?>
